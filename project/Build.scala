...
object Build extends sbt.Build {
  ...
  lazy val root = Project(id = "akka-kryo-serialization-shaded", base = file(".")).settings(

    organization := "nl.dgl.romix.akka",
    resolvers += typesafe,
    ...
    libraryDependencies += "org.apache.tinkerpop" % "gremlin-shaded" %  "3.4.1",
